            ...
            <div className="col">
                <div className="card h-100 position-relative">
                    ...
                    <div className="card-body">
                        ...
                        <button className="btn" onClick={onSeeMore}>See more</button>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="feature_product container my-5">
            ...
            {popupData && (
                ...
                //     }}
                // >
                //     <div className="popup-content position-relative bg-white p-4 rounded">
                //         <button
                ...
                //         <img src={popupData.imgSrc} alt={popupData.title} className="img-fluid" />
                //     </div>
                // </div>
